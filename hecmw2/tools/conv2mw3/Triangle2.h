...
|
 ----------------------------------------------------------
*/
#ifndef A59AA580_C2CE_432f_83D3_5D14D394003C
#define A59AA580_C2CE_432f_83D3_5D14D394003C

#include "Element.h"

class CTriangle2 : public CElement
{
public:
	CTriangle2(void);
	virtual ~CTriangle2(void);

	virtual size_t getNodeID_Fistr2MW3(size_t index);

	virtual size_t getNumOfFace(){return 1;}
	virtual size_t getNumOfEdge(){ return 3;}
	virtual const char* getCType(){ return "Triangle2";}
	virtual size_t getNType(){ return FistrElementType::Triangle2;}
