...
//----
int mw_initialize_(int* argc, char** argv);// MW3 standard
int mw_initialize_fstr_(int* argc, char** argv, char* cntpath, char* datpath);// for FrontISTR
int mw_finalize_();

//----
// file i/o API
//----
int mw_file_read_();    // mesh_file read
int mw_file_read_fstr_();    // mesh_file read
int mw_file_read_bin_();// mesh_file read (binary file)
int mw_file_write_();// data_check file write
//----
// result, format = %d:int*, %f:double*(fixed), %e:double*(scientific), %s:const char*
//----
void mw_rlt_start_();
void mw_rlt_start_bin_();
int mw_rlt_print_(int* width, char* format, ... );
void mw_rlt_end_();
//----
// restart, linear_algebra_equation info
//----
int mw_file_write_res_();// restart file write
int mw_set_restart_();// restart file read, linear_algebra_equation info
int mw_file_write_res_bin_();// restart file write (binary file)
int mw_set_restart_bin_();// restart file read, linear_algebra_equation info (binary file)
...
int mw_matrix_rhs_set_bc2_(int* imesh, int* inode, int* dof, double* diagval, double* solval);// diagonal=1, off_diag=0 and X
int mw_matrix_rhs_set_bc_(int* imesh, int* inode, int* dof, double* diagval, double* rhsval); // penalty method, diagonal and rhs_vector
...
//--
double mw_get_solution_assy_vector_val_(int* imesh, int* inode, int* idof);
double mw_get_rhs_assy_vector_val_(int* imesh, int* inode, int* idof);
//--
// solution vector dof, rhs vector dof
//--
int mw_get_solution_assy_vector_dof_();
int mw_get_rhs_assy_vector_dof_();
...
int mw_get_bnd_type_bnode_mesh_(int* ibmesh);
int mw_get_bnd_type_bface_mesh_(int* ibmesh);
int mw_get_bnd_type_bedge_mesh_(int* ibmesh);
int mw_get_bnd_type_bvolume_mesh_(int* ibmesh);
// BND type number
int mw_get_neumann_type_();
int mw_get_dirichlet_type_();
...
int mw_get_dof_bnode_mesh_(int* ibmesh, int* ibnode, int* idof);
int mw_get_dof_bface_mesh_(int* ibmesh, int* idof);
int mw_get_dof_bedge_mesh_(int* ibmesh, int* idof);
int mw_get_dof_bvolume_mesh_(int* ibmesh, int* idof);
//--
...
//--
int mw_get_num_of_node_bface_(int* ibmesh, int* ibface);
int mw_get_node_id_bface_(int* ibmesh, int* ibface, int* ibnode);
int mw_get_num_of_node_bedge_(int* ibmesh, int* ibedge);
int mw_get_node_id_bedge_(int* ibmesh, int* ibedge, int* ibnode);
int mw_get_num_of_node_bvolume_(int* ibmesh, int* ibvol);
int mw_get_node_id_bvolume_(int* ibmesh, int* ibvol, int* ibnode);
//--
// boundary_mesh name
//--
...
int mw_get_node_id_comm_node_(int* icmesh, int* icnode);//MeshのNodeID
