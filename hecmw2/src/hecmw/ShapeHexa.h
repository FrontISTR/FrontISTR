...
public:
    ...
    // dNdx (空間座標の導関数)
    double& dNdx81(const uiint& igauss, const uiint& ishape, const uiint& axis){  return  mvdNdx81[igauss][ishape][axis];}
    double& dNdx82(const uiint& igauss, const uiint& ishape, const uiint& axis){  return  mvdNdx82[igauss][ishape][axis];}
    double& dNdx201(const uiint& igauss, const uiint& ishape, const uiint& axis){ return mvdNdx201[igauss][ishape][axis];}
    double& dNdx202(const uiint& igauss, const uiint& ishape, const uiint& axis){ return mvdNdx202[igauss][ishape][axis];}
    double& dNdx203(const uiint& igauss, const uiint& ishape, const uiint& axis){ return mvdNdx203[igauss][ishape][axis];}

    vvdouble& dNdx81(const uiint& igauss){  return  mvdNdx81[igauss];}
    vvdouble& dNdx82(const uiint& igauss){  return  mvdNdx82[igauss];}
    vvdouble& dNdx201(const uiint& igauss){ return mvdNdx201[igauss];}
    vvdouble& dNdx202(const uiint& igauss){ return mvdNdx202[igauss];}
    vvdouble& dNdx203(const uiint& igauss){ return mvdNdx203[igauss];}
    ...
    double& detJ81(const uiint& igauss){ return mv_detJ81[igauss];}
    double& detJ82(const uiint& igauss){ return mv_detJ82[igauss];}
    double& detJ201(const uiint& igauss){ return mv_detJ201[igauss];}
    double& detJ202(const uiint& igauss){ return mv_detJ202[igauss];}
    double& detJ203(const uiint& igauss){ return mv_detJ203[igauss];}
    ...
    double& getIntegralValue20(const uiint& ishape){ return mvIntegValue20[ishape];}
    double& getIntegralValue8(const uiint& ishape){ return mvIntegValue8[ishape];}
};
#endif	/* _SHAPEHEXA_H */
}
