...
__declspec(dllexport) void mw_print_avs_basis_();
...
__declspec(dllexport) iint mw_set_restart_(iint* step);
__declspec(dllexport) iint mw_file_write_res_bin_(iint* step);
__declspec(dllexport) iint mw_set_restart_bin_(iint* step);
...
__declspec(dllexport) iint mw_matrix_rhs_set_bc2_(iint* imesh, iint* inode, iint* dof, double* diagval, double* solval);
__declspec(dllexport) iint mw_matrix_rhs_set_bc_(iint* imesh, iint* inode, iint* dof, double* diagval, double* rhsval); 
__declspec(dllexport) iint mw_rhs_set_bc_(iint* imesh, iint* inode, iint* dof, double* value);
...
__declspec(dllexport) iint mw_refine_(int* num_of_refine);      
__declspec(dllexport) iint mw_mg_construct_(int* num_of_refine);
...
__declspec(dllexport) int mw_mpi_int_();   
__declspec(dllexport) int mw_mpi_double_();
__declspec(dllexport) int mw_mpi_comm_();  
__declspec(dllexport) int mw_mpi_sum_();
__declspec(dllexport) int mw_mpi_max_();
__declspec(dllexport) int mw_mpi_min_();
...
__declspec(dllexport) int mw_get_num_of_neibpe_(int* imesh);
__declspec(dllexport) int mw_get_transrank_(int* imesh, int* ipe);
__declspec(dllexport) void mw_send_recv_r_(double buf[], int* num_of_node, int* dof_size, int* trans_rank);
