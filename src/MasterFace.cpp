...
void CMasterFace::addSlaveNode(CContactNode* pConNode)
{
    ...
    if(iprod==numOfVert || iprod== -numOfVert){
...
/*
    ...
    double& s_NearCrossP();
    double& t_NearCrossP();
    void NearCrossP(const vdouble& vL1, const vdouble& vL2, const vdouble& L1P0, const vdouble& L2P0);
    ...
    double& r_NearCrossP(const vdouble& L1P0, const vdouble& L2P0);
 */
...
void CMasterFace::CalcSlave(const uint& islave, const uint& valType)
{
    ...
    vdouble vOP;       vOP.resize(3);
    vdouble vNP0,vNP1; vNP0.resize(3);vNP1.resize(3);
    vdouble vE,vF;     vE.resize(3); vF.resize(3);   
    vdouble vPOP;  vPOP.resize(3); 
    vdouble vP2P3; vP2P3.resize(3);
    vdouble vP1P0; vP1P0.resize(3);
    vdouble vInterP0,vInterP1; vInterP0.resize(3);vInterP1.resize(3);
