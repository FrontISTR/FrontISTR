...
void CBoundingBox::sizingOBB(CSkinFace* pFace)
{
    ...
    //OBB座標 Y方向
    X1= mvOBBZ[0]-mvOBBCenter[0];
    Y1= mvOBBZ[1]-mvOBBCenter[1];
    Z1= mvOBBZ[2]-mvOBBCenter[2];

    X2= mvOBBX[0]-mvOBBCenter[0];
    Y2= mvOBBX[1]-mvOBBCenter[1];
    Z2= mvOBBX[2]-mvOBBCenter[2];
