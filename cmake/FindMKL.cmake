...
if(WITH_MPI AND MKL_LIBRARIES)
  ...
  if(MKLBLACS_LIBRARY)
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
      ...
      # Keep the wrapper and its options together during CMake link ordering.
      set(_mkl_blacs_link "-Wl,--push-state,--no-as-needed")
      if(MKLBLACS_LIBRARY MATCHES "\\.a$")
        string(APPEND _mkl_blacs_link ",--undefined=MKLMPI_Get_wrappers,--export-dynamic")
      endif()
      string(APPEND _mkl_blacs_link ",${MKLBLACS_LIBRARY},--pop-state")
      list(APPEND MKL_LIBRARIES "${_mkl_blacs_link}")
      unset(_mkl_blacs_link)
    else()
    ...
    message(STATUS "MKL BLACS was not found. Cluster PARDISO requires a matching LP64 BLACS library; set MKLBLACS_LIBRARY explicitly.")
  endif()
