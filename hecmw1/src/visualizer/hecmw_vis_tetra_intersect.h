...
extern int get_tetra_data(Surface *sff, struct hecmwST_local_mesh *mesh,
                          struct hecmwST_result_data *data, int elemID,
                          Tetra *tetra, int tn_component);
extern void find_intersection_tetra(Tetra *tetra, double isovalue,
