  ...
  while ((visual_method > 0) && (cont_flag == 1)) {
    ...
    if ((visual_method == 1) && (cont_flag == 1)) {
      ...
      for (i = 0; i < NUM_CONTROL_PSF; i++) {
        parameters[i] = (char *)HECMW_calloc(para_size, sizeof(char));
        if (parameters[i] == NULL)
          HECMW_vis_memory_exit("temporary parameters: Parameter");
      }
      snprintf(parameters[0], para_size, "surface_style");
      len_para[0] = 12;
      snprintf(parameters[1], para_size, "group_name");
      len_para[1] = 10;
      snprintf(parameters[2], para_size, "defined_style");
      len_para[2] = 12;
      snprintf(parameters[3], para_size, "data_comp_name");
      len_para[3] = 12;
      snprintf(parameters[4], para_size, "data_comp");
      len_para[4] = 9;
      snprintf(parameters[5], para_size, "data_subcomp_name");
      len_para[5] = 14;
      snprintf(parameters[6], para_size, "data_subcomp");
      len_para[6] = 12;
      snprintf(parameters[7], para_size, "iso_value");
      len_para[7] = 9;
      snprintf(parameters[8], para_size, "method");
      len_para[8] = 6;
      snprintf(parameters[9], para_size, "point");
      len_para[9] = 5;
      snprintf(parameters[10], para_size, "radius");
      len_para[10] = 6;
      snprintf(parameters[11], para_size, "length");
      len_para[11] = 6;
      snprintf(parameters[12], para_size, "coef");
      len_para[12] = 4;
      snprintf(parameters[13], para_size, "display_method");
      len_para[13] = 14;
      snprintf(parameters[14], para_size, "color_comp_name");
      len_para[14] = 14;
      snprintf(parameters[15], para_size, "color_comp");
      len_para[15] = 10;
      snprintf(parameters[16], para_size, "color_subcomp_name");
      len_para[16] = 18;
      snprintf(parameters[17], para_size, "color_subcomp");
      len_para[17] = 13;
      snprintf(parameters[18], para_size, "isoline_number");
      len_para[18] = 14;
      snprintf(parameters[19], para_size, "specified_color");
      len_para[19] = 14;
      snprintf(parameters[20], para_size, "output_type");
      len_para[20] = 11;
      snprintf(parameters[21], para_size, "range_filename");
      len_para[21] = 10;
      snprintf(parameters[22], para_size, "normalize_on");
      len_para[22] = 12;

      snprintf(parameters[23], para_size, "x_resolution");
      snprintf(parameters[24], para_size, "y_resolution");
      len_para[23] = len_para[24] = 12;
      snprintf(parameters[25], para_size, "num_of_lights");
      len_para[25] = 13;
      snprintf(parameters[26], para_size, "position_of_lights");
      len_para[26] = 18;
      snprintf(parameters[27], para_size, "viewpoint");
      len_para[27] = 9;
      snprintf(parameters[28], para_size, "look_at_point");
      len_para[28] = 13;
      snprintf(parameters[29], para_size, "up_direction");
      len_para[29] = 12;
      snprintf(parameters[30], para_size, "ambient_coef");
      len_para[30] = 12;
      snprintf(parameters[31], para_size, "diffuse_coef");
      len_para[31] = 12;
      snprintf(parameters[32], para_size, "specular_coef");
      len_para[32] = 13;
      snprintf(parameters[33], para_size, "color_mapping_style");
      len_para[33] = 19;
      snprintf(parameters[34], para_size, "interval_mapping_num");
      len_para[34] = 20;
      snprintf(parameters[35], para_size, "interval_mapping");
      len_para[35] = 16;
      snprintf(parameters[36], para_size, "rotate_style");
      len_para[36] = 12;
      snprintf(parameters[37], para_size, "rotate_num_of_frames");
      len_para[37] = 15;
      snprintf(parameters[38], para_size, "color_mapping_bar_on");
      len_para[38] = 17;
      snprintf(parameters[39], para_size, "scale_marking_on");
      len_para[39] = 15;
      snprintf(parameters[40], para_size, "background_color");
      len_para[40] = 12;
      snprintf(parameters[41], para_size, "font_color");
      len_para[41] = 9;
      snprintf(parameters[42], para_size, "color_system_type");
      len_para[42] = 12;
      snprintf(parameters[43], para_size, "font_size");
      len_para[43] = 8;
      snprintf(parameters[44], para_size, "color_bar_style");
      len_para[44] = 13;
      snprintf(parameters[45], para_size, "fixed_range_on");
      len_para[45] = 11;
      snprintf(parameters[46], para_size, "range_value");
      len_para[46] = 11;
      snprintf(parameters[47], para_size, "num_of_scale");
      len_para[47] = 11;
      snprintf(parameters[48], para_size, "mark_0_on");
      len_para[48] = 9;
      snprintf(parameters[49], para_size, "opacity_mapping_style");
      len_para[49] = 21;
      snprintf(parameters[50], para_size, "opa_value");
      len_para[50] = 8;
      snprintf(parameters[51], para_size, "num_of_features");
      len_para[51] = 14;
      snprintf(parameters[52], para_size, "fea_point");
      len_para[52] = 8;
      snprintf(parameters[53], para_size, "lookup_filename");
      len_para[53] = 15;
      snprintf(parameters[54], para_size, "histogram_on");
      len_para[54] = 11;
      snprintf(parameters[55], para_size, "boundary_line_on");
      len_para[55] = 11;
      snprintf(parameters[56], para_size, "isoline_color");
      len_para[56] = 12;
      snprintf(parameters[57], para_size, "time_mark_on");
      len_para[57] = 10;
      snprintf(parameters[58], para_size, "fixed_scale_mark");
      len_para[58] = 15;
      snprintf(parameters[59], para_size, "deform_display_on");
      len_para[59] = 13;
      snprintf(parameters[60], para_size, "deform_scale");
      len_para[60] = 11;
      snprintf(parameters[61], para_size, "initial_style");
      len_para[61] = 12;
      snprintf(parameters[62], para_size, "deform_style");
      len_para[62] = 11;
      snprintf(parameters[63], para_size, "deform_comp_name");
      len_para[63] = 15;
      snprintf(parameters[64], para_size, "deform_comp");
      len_para[64] = 11;
      snprintf(parameters[65], para_size, "initial_line_color");
      len_para[65] = 15;
      snprintf(parameters[66], para_size, "deform_line_color");
      len_para[66] = 15;
      snprintf(parameters[67], para_size, "deform_num_of_frames");
      len_para[67] = 15;
      snprintf(parameters[68], para_size, "smooth_shading_on");
      len_para[68] = 15;
      snprintf(parameters[69], para_size, "real_deform_scale");
      len_para[69] = 16;
      snprintf(parameters[70], para_size, "fixed_mesh_range");
      len_para[70] = 14;
      snprintf(parameters[71], para_size, "start_time");
      len_para[71] = 9;
      snprintf(parameters[72], para_size, "time_interval");
      len_para[72] = 9;
...
fprintf(stderr, "*********current PSF number= %d\n", psf->num_of_psf);
      ...
      vr->color_comp    = -1;
      vr->color_subcomp = -1;
      snprintf(parameters[0], para_size, "maximum_refinement");
      len_para[0] = 18;
      snprintf(parameters[1], para_size, "x_resolution");
      snprintf(parameters[2], para_size, "y_resolution");
      len_para[1] = len_para[2] = 12;
      snprintf(parameters[3], para_size, "num_of_lights");
      len_para[3] = 13;
      snprintf(parameters[4], para_size, "position_of_lights");
      len_para[4] = 18;
      snprintf(parameters[5], para_size, "viewpoint");
      len_para[5] = 9;
      snprintf(parameters[6], para_size, "look_at_point");
      len_para[6] = 13;
      snprintf(parameters[7], para_size, "up_direction");
      len_para[7] = 12;
      snprintf(parameters[8], para_size, "ambient_coef");
      len_para[8] = 12;
      snprintf(parameters[9], para_size, "diffuse_coef");
      len_para[9] = 12;
      snprintf(parameters[10], para_size, "specular_coef");
      len_para[10] = 13;
      snprintf(parameters[11], para_size, "surface_on");
      len_para[11] = 10;
      snprintf(parameters[12], para_size, "surface_opacity");
      len_para[12] = 15;
      snprintf(parameters[13], para_size, "color_mapping_style");
      len_para[13] = 19;
      snprintf(parameters[14], para_size, "interval_mapping_num");
      len_para[14] = 20;
      snprintf(parameters[15], para_size, "interval_mapping");
      len_para[15] = 16;
      snprintf(parameters[16], para_size, "opacity_mapping_style");
      len_para[16] = 21;
      snprintf(parameters[17], para_size, "opacity_value");
      len_para[17] = 13;
      snprintf(parameters[18], para_size, "num_of_features");
      len_para[18] = 14;
      snprintf(parameters[19], para_size, "feature_points");
      len_para[19] = 14;
      snprintf(parameters[20], para_size, "lookup_filename");
      len_para[20] = 15;
      snprintf(parameters[21], para_size, "rotate_style");
      len_para[21] = 12;
      snprintf(parameters[22], para_size, "voxel_filename");
      len_para[22] = 10;
      snprintf(parameters[23], para_size, "color_mapping_bar_on");
      len_para[23] = 17;
      snprintf(parameters[24], para_size, "scale_marking_on");
      len_para[24] = 15;
      snprintf(parameters[25], para_size, "color_comp_name");
      len_para[25] = 14;
      snprintf(parameters[26], para_size, "color_subcomp_name");
      len_para[26] = 17;
      snprintf(parameters[27], para_size, "n_voxel_x");
      len_para[27] = 9;
      snprintf(parameters[28], para_size, "n_voxel_y");
      len_para[28] = 9;
      snprintf(parameters[29], para_size, "n_voxel_z");
      len_para[29] = 9;
      snprintf(parameters[30], para_size, "surface_filename");
      len_para[30] = 12;
      snprintf(parameters[31], para_size, "num_of_frames");
      len_para[31] = 12;
      snprintf(parameters[32], para_size, "background_color");
      len_para[32] = 12;
      snprintf(parameters[33], para_size, "font_color");
      len_para[33] = 9;
      snprintf(parameters[34], para_size, "color_system_type");
      len_para[34] = 12;
      snprintf(parameters[35], para_size, "font_size");
      len_para[35] = 8;
      snprintf(parameters[36], para_size, "color_bar_style");
      len_para[36] = 13;
      snprintf(parameters[37], para_size, "fixed_range_on");
      len_para[37] = 11;
      snprintf(parameters[38], para_size, "range_value");
      len_para[38] = 11;
      snprintf(parameters[39], para_size, "num_of_scale");
      len_para[39] = 11;
      snprintf(parameters[40], para_size, "mark_0_on");
      len_para[40] = 9;
      snprintf(parameters[41], para_size, "remove_0_display_on");
      len_para[41] = 17;
      snprintf(parameters[42], para_size, "x_specified_level");
      len_para[42] = 15;
      snprintf(parameters[43], para_size, "y_specified_level");
      len_para[43] = 15;
      snprintf(parameters[44], para_size, "z_specified_level");
      len_para[44] = 15;
      snprintf(parameters[45], para_size, "histogram_on");
      len_para[45] = 10;
      snprintf(parameters[46], para_size, "display_range");
      len_para[46] = 13;
      snprintf(parameters[47], para_size, "time_mark_on");
      len_para[47] = 10;
      snprintf(parameters[48], para_size, "fixed_scale_mark");
      len_para[48] = 15;
      snprintf(parameters[49], para_size, "color_comp");
      len_para[49] = 9;
      snprintf(parameters[50], para_size, "color_subcomp");
      len_para[50] = 12;
