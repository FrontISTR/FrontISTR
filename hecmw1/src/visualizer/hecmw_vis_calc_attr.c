...
void get_edgepoint(int edge_index, Cell *cell, double fvalue, Fgeom *vert_geom,
                   double *cdata) {
...
void get_insidepoint(int inside_index, Cell *cell, double fvalue,
  ...
  switch (inside_index) {
    ...
    case 6:
      vert_geom->x =
          (cell->axis[0] + cell->axis[3] + cell->axis[6] + cell->axis[9] +
           cell->axis[12] + cell->axis[15] + cell->axis[18] + cell->axis[21]) /
          8.0;
      vert_geom->y =
          (cell->axis[1] + cell->axis[4] + cell->axis[7] + cell->axis[10] +
           cell->axis[13] + cell->axis[16] + cell->axis[19] + cell->axis[22]) /
          8.0;
      vert_geom->z =
          (cell->axis[2] + cell->axis[5] + cell->axis[8] + cell->axis[11] +
           cell->axis[14] + cell->axis[17] + cell->axis[20] + cell->axis[23]) /
          8.0;
      *cdata = (cell->c_data[0] + cell->c_data[1] + cell->c_data[2] +
                cell->c_data[3] + cell->c_data[4] + cell->c_data[5] +
                cell->c_data[6] + cell->c_data[7]) /
               8.0;
      break;
  }
}
