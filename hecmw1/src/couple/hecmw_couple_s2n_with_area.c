...
static int
s2n_with_area_tet1(const struct hecmwST_local_mesh *mesh,
...
static int
s2n_with_area_hex1(const struct hecmwST_local_mesh *mesh,
		const struct hecmw_couple_boundary *boundary, int id, struct link_list *weight_list)
{
...
static int
s2n_with_area(const struct hecmwST_local_mesh *mesh, const struct hecmw_couple_boundary *boundary,
...
HECMW_couple_s2n_with_area(const struct hecmwST_local_mesh *mesh,
