...
static void calc_gravity_tri(double p1_x, double p1_y, double p1_z, double p2_x,
                             double p2_y, double p2_z, double p3_x, double p3_y,
                             double p3_z, double *g_x, double *g_y,
                             double *g_z) {
...
static void calc_gravity_quad(double p1_x, double p1_y, double p1_z,
...
static void calc_normal_vector_tri(double p1_x, double p1_y, double p1_z,
                                   double p2_x, double p2_y, double p2_z,
                                   double p3_x, double p3_y, double p3_z,
                                   double *vn_x, double *vn_y, double *vn_z) {
...
static void calc_normal_vector_quad(double p1_x, double p1_y, double p1_z,
                                    double p2_x, double p2_y, double p2_z,
                                    double p3_x, double p3_y, double p3_z,
                                    double p4_x, double p4_y, double p4_z,
                                    double *vn_x, double *vn_y, double *vn_z) {
...
static double calc_dot_product(double v1_x, double v1_y, double v1_z,
...
static int calc_dot_product_tri(double p1_x, double p1_y, double p1_z,
                                double p2_x, double p2_y, double p2_z,
                                double p3_x, double p3_y, double p3_z,
  ...
  calc_normal_vector_tri(p1_x, p1_y, p1_z, p2_x, p2_y, p2_z, p3_x, p3_y, p3_z,
                         &vn_x, &vn_y, &vn_z);
  calc_gravity_tri(p1_x, p1_y, p1_z, p2_x, p2_y, p2_z, p3_x, p3_y, p3_z, &g_x,
                   &g_y, &g_z);
  ...
  *distance =
      fabs(*dot_product / sqrt(vn_x * vn_x + vn_y * vn_y + vn_z * vn_z));

  return *dot_product;
}

static int calc_dot_product_quad(double p1_x, double p1_y, double p1_z,
                                 double p2_x, double p2_y, double p2_z,
                                 double p3_x, double p3_y, double p3_z,
                                 double p4_x, double p4_y, double p4_z,
                                 double p_x, double p_y, double p_z,
  ...
  calc_normal_vector_quad(p1_x, p1_y, p1_z, p2_x, p2_y, p2_z, p3_x, p3_y, p3_z,
                          p4_x, p4_y, p4_z, &vn_x, &vn_y, &vn_z);

  calc_gravity_quad(p1_x, p1_y, p1_z, p2_x, p2_y, p2_z, p3_x, p3_y, p3_z, p4_x,
                    p4_y, p4_z, &g_x, &g_y, &g_z);
...
extern int HECMW_couple_judge_tet1(const struct hecmwST_local_mesh *local_mesh,
                                   int elem, int surf_id, double coord_px,
  ...
  calc_dot_product_tri(coord_x[1], coord_y[1], coord_z[1], coord_x[2],
                       coord_y[2], coord_z[2], coord_x[3], coord_y[3],
                       coord_z[3], coord_px, coord_py, coord_pz,
                       &_dot_product[0], &_distance[0]);
  calc_dot_product_tri(coord_x[0], coord_y[0], coord_z[0], coord_x[3],
                       coord_y[3], coord_z[3], coord_x[2], coord_y[2],
                       coord_z[2], coord_px, coord_py, coord_pz,
                       &_dot_product[1], &_distance[1]);
  calc_dot_product_tri(coord_x[0], coord_y[0], coord_z[0], coord_x[1],
                       coord_y[1], coord_z[1], coord_x[3], coord_y[3],
                       coord_z[3], coord_px, coord_py, coord_pz,
                       &_dot_product[2], &_distance[2]);
  calc_dot_product_tri(coord_x[0], coord_y[0], coord_z[0], coord_x[2],
                       coord_y[2], coord_z[2], coord_x[1], coord_y[1],
                       coord_z[1], coord_px, coord_py, coord_pz,
...
extern int HECMW_couple_judge_hex1(const struct hecmwST_local_mesh *local_mesh,
                                   int elem, int surf_id, double coord_px,
                                   double coord_py, double coord_pz,
                                   double *dot_product, double *distance) {
