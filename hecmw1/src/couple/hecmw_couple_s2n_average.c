...
static int s2n_average_tet1(const struct hecmwST_local_mesh *mesh,
...
static int s2n_average_hex1(const struct hecmwST_local_mesh *mesh,
                            const struct hecmw_couple_boundary *boundary,
                            int id, struct link_list *weight_list) {
  struct link_list *p;
  int node_id, n, i;
...
static int s2n_average(const struct hecmwST_local_mesh *mesh,
                       const struct hecmw_couple_boundary *boundary,
