...
static int set_hecmw_flag_adapt(void *src) {
  mesh->hecmw_flag_adapt = *((int *)src);
  return 0;
}

static int set_hecmw_flag_initcon(void *src) {
  mesh->hecmw_flag_initcon = *((int *)src);
  return 0;
}

static int set_hecmw_flag_parttype(void *src) {
  mesh->hecmw_flag_parttype = *((int *)src);
  return 0;
}

static int set_hecmw_flag_partdepth(void *src) {
  mesh->hecmw_flag_partdepth = *((int *)src);
  return 0;
}

static int set_hecmw_flag_version(void *src) {
  mesh->hecmw_flag_version = *((int *)src);
  return 0;
}

static int set_hecmw_flag_partcontact(void *src) {
  mesh->hecmw_flag_partcontact = *((int *)src);
  return 0;
}

static int set_gridfile(void *src) {
  void *dst = mesh->gridfile;
  HECMW_strcpy_f2c_r(src, HECMW_FILENAME_LEN, dst, HECMW_FILENAME_LEN + 1);
  return 0;
}

static int set_hecmw_n_file(void *src) {
  mesh->hecmw_n_file = *((int *)src);
  return 0;
}

static int set_files(void *src) {
  int i;
...
static int set_header(void *src) {
  void *dst = mesh->header;
  HECMW_strcpy_f2c_r(src, HECMW_HEADER_LEN, dst, HECMW_HEADER_LEN + 1);
  return 0;
}

static int set_zero_temp(void *src) {
  mesh->zero_temp = *((double *)src);
  return 0;
}

static int set_n_node(void *src) {
  mesh->n_node = *((int *)src);
  return 0;
}

static int set_n_node_gross(void *src) {
  mesh->n_node_gross = *((int *)src);
  return 0;
}

static int set_nn_middle(void *src) {
  mesh->nn_middle = *((int *)src);
  return 0;
}

static int set_nn_internal(void *src) {
  mesh->nn_internal = *((int *)src);
  return 0;
}

static int set_node_internal_list(void *src) {
  int size;
...
static int set_node_ID(void *src) {
  int size;
...
static int set_global_node_ID(void *src) {
  int size;
...
static int set_n_dof(void *src) {
  mesh->n_dof = *((int *)src);
  return 0;
}

static int set_n_dof_grp(void *src) {
  mesh->n_dof_grp = *((int *)src);
  return 0;
}

static int set_n_dof_tot(void *src) {
  mesh->n_dof_tot = *((int *)src);
  return 0;
}

static int set_node_dof_index(void *src) {
  int size;
...
static int set_node_dof_item(void *src) {
  int size;
...
static int set_node_val_index(void *src) {
  int size;
...
static int set_node_init_val_index(void *src) {
  int size;
...
static int set_node_init_val_item(void *src) {
  int size;
...
static int set_n_elem(void *src) {
  mesh->n_elem = *((int *)src);
  return 0;
}

static int set_n_elem_gross(void *src) {
  mesh->n_elem_gross = *((int *)src);
  return 0;
}

static int set_ne_internal(void *src) {
  mesh->ne_internal = *((int *)src);
  return 0;
}

static int set_elem_internal_list(void *src) {
  int size;
...
static int set_elem_ID(void *src) {
  int size;
...
static int set_global_elem_ID(void *src) {
  int size;
...
static int set_elem_type(void *src) {
  int size;
...
static int set_n_elem_type(void *src) {
  mesh->n_elem_type = *((int *)src);
  return 0;
}

static int set_elem_type_index(void *src) {
  int size;
...
static int set_elem_type_item(void *src) {
  int size;
...
static int set_elem_node_item(void *src) {
  int size;
...
static int set_section_ID(void *src) {
  int size;
...
static int set_n_elem_mat_ID(void *src) {
  mesh->n_elem_mat_ID = *((int *)src);
  return 0;
}

static int set_elem_mat_ID_index(void *src) {
  int size;
...
static int set_elem_mat_ID_item(void *src) {
  int size;
...
static int set_elem_mat_int_index(void *src) {
  int size;
...
static int set_elem_mat_int_val(void *src) {
  int size;
  ...
  size = sizeof(*mesh->elem_mat_int_val) *
         mesh->elem_mat_int_index[mesh->n_elem_gross];
...
static int set_elem_val_index(void *src) {
  int size;
...
static int set_zero(void *src) {
  mesh->zero = *((int *)src);
  return 0;
}

static int set_HECMW_COMM(void *src) {
  mesh->HECMW_COMM = HECMW_Comm_f2c(*((HECMW_Fint *)src));
  return 0;
}

static int set_PETOT(void *src) {
  mesh->PETOT = *((int *)src);
  return 0;
}

static int set_PEsmpTOT(void *src) {
  mesh->PEsmpTOT = *((int *)src);
  return 0;
}

static int set_my_rank(void *src) {
  mesh->my_rank = *((int *)src);
  return 0;
}

static int set_errnof(void *src) {
  mesh->errnof = *((int *)src);
  return 0;
}

static int set_n_subdomain(void *src) {
  mesh->n_subdomain = *((int *)src);
  return 0;
}

static int set_n_neighbor_pe(void *src) {
  mesh->n_neighbor_pe = *((int *)src);
  return 0;
}

static int set_neighbor_pe(void *src) {
  int size;
...
static int set_import_index(void *src) {
  int size;
...
static int set_import_item(void *src) {
  int size;
...
static int set_export_index(void *src) {
  int size;
...
static int set_export_item(void *src) {
  int size;
...
static int set_shared_index(void *src) {
  int size;
...
static int set_shared_item(void *src) {
  int size;
...
static int set_coarse_grid_level(void *src) {
  mesh->coarse_grid_level = *((int *)src);
  return 0;
}

static int set_n_adapt(void *src) {
  mesh->n_adapt = *((int *)src);
  return 0;
}

static int set_when_i_was_refined_node(void *src) {
  int size;
...
static int set_when_i_was_refined_elem(void *src) {
  int size;
...
static int set_adapt_parent_type(void *src) {
  int size;
...
static int set_adapt_type(void *src) {
  int size;
...
static int set_adapt_level(void *src) {
  int size;
...
static int set_adapt_parent(void *src) {
  int size;
...
static int set_adapt_children_index(void *src) {
  int size;
...
static int set_adapt_children_item(void *src) {
  int size;
  ...
  size = sizeof(*mesh->adapt_children_item) * 2 *
         mesh->adapt_children_index[mesh->n_elem_gross];
...
static int set_n_refine(void *src) {
  mesh->n_refine = *((int *)src);
  return 0;
}

static int set_node_old2new(void *src) {
  int size;
...
static int set_node_new2old(void *src) {
  int size;
...
static int set_elem_old2new(void *src) {
  int size;
...
static int set_elem_new2old(void *src) {
  int size;
...
static int set_n_node_refine_hist(void *src) {
  int size;

  if (mesh->n_elem_gross <= 0) return 0;
  size                     = sizeof(*mesh->n_node_refine_hist) * mesh->n_refine;
  mesh->n_node_refine_hist = HECMW_malloc(size);
  if (mesh->n_node_refine_hist == NULL) {
    HECMW_set_error(errno, "");
    return -1;
  }
  memcpy(mesh->n_node_refine_hist, src, size);
  return 0;
}

static int set_n_sect(void *src) {
  mesh->section->n_sect = *((int *)src);
  return 0;
}

static int set_sect_type(void *src) {
  int size;
...
static int set_sect_opt(void *src) {
  int size;
...
static int set_sect_mat_ID_index(void *src) {
  int size;

  if (mesh->section->n_sect <= 0) return 0;
  size =
      sizeof(*mesh->section->sect_mat_ID_index) * (mesh->section->n_sect + 1);
...
static int set_sect_mat_ID_item(void *src) {
  int size;
  ...
  size = sizeof(*mesh->section->sect_mat_ID_item) *
         mesh->section->sect_mat_ID_index[mesh->section->n_sect];
...
static int set_sect_I_index(void *src) {
  int size;
...
static int set_sect_I_item(void *src) {
  int size;
  ...
  size = sizeof(*mesh->section->sect_I_item) *
         mesh->section->sect_I_index[mesh->section->n_sect];
...
static int set_sect_R_index(void *src) {
  int size;
...
static int set_sect_R_item(void *src) {
  int size;
  ...
  size = sizeof(*mesh->section->sect_R_item) *
         mesh->section->sect_R_index[mesh->section->n_sect];
...
static int set_n_mat(void *src) {
  mesh->material->n_mat = *((int *)src);
  return 0;
}

static int set_n_mat_item(void *src) {
  mesh->material->n_mat_item = *((int *)src);
  return 0;
}

static int set_n_mat_subitem(void *src) {
  mesh->material->n_mat_subitem = *((int *)src);
  return 0;
}

static int set_n_mat_table(void *src) {
  mesh->material->n_mat_table = *((int *)src);
  return 0;
}

static int set_mat_name(void *src) {
  int i;
...
static int set_mat_item_index(void *src) {
  int size;
...
static int set_mat_subitem_index(void *src) {
  int size;

  if (mesh->material->n_mat_item <= 0) return 0;
  size = sizeof(*mesh->material->mat_subitem_index) *
         (mesh->material->n_mat_item + 1);
...
static int set_mat_table_index(void *src) {
  int size;

  if (mesh->material->n_mat_subitem <= 0) return 0;
  size = sizeof(*mesh->material->mat_table_index) *
         (mesh->material->n_mat_subitem + 1);
...
static int set_mat_val(void *src) {
  int size;
...
static int set_mat_temp(void *src) {
  int size;
...
static int set_n_mpc(void *src) {
  mesh->mpc->n_mpc = *((int *)src);
  return 0;
}

static int set_mpc_index(void *src) {
  int size;
...
static int set_mpc_item(void *src) {
  int size;
...
static int set_mpc_dof(void *src) {
  int size;
...
static int set_mpc_val(void *src) {
  int size;
...
static int set_mpc_const(void *src) {
  int size;
...
static int set_n_amp(void *src) {
  mesh->amp->n_amp = *((int *)src);
  return 0;
}

static int set_amp_name(void *src) {
  int i;
...
static int set_amp_type_definition(void *src) {
  int size;
...
static int set_amp_type_time(void *src) {
  int size;
...
static int set_amp_type_value(void *src) {
  int size;
...
static int set_amp_index(void *src) {
  int size;
...
static int set_amp_val(void *src) {
  int size;
...
static int set_amp_table(void *src) {
  int size;
...
static int set_ngrp_n_grp(void *src) {
  mesh->node_group->n_grp = *((int *)src);
  return 0;
}

static int set_ngrp_n_bc(void *src) {
  mesh->node_group->n_bc = *((int *)src);
  return 0;
}

static int set_ngrp_grp_name(void *src) {
  int i;
...
static int set_ngrp_grp_index(void *src) {
  int size;
...
static int set_ngrp_grp_item(void *src) {
  int size;
  ...
  size = sizeof(*mesh->node_group->grp_item) *
         mesh->node_group->grp_index[mesh->node_group->n_grp];
...
static int set_ngrp_bc_grp_ID(void *src) {
  int size;
...
static int set_ngrp_bc_grp_type(void *src) {
  int size;
...
static int set_ngrp_bc_grp_index(void *src) {
  int size;
...
static int set_ngrp_bc_grp_dof(void *src) {
  int size;
...
static int set_ngrp_bc_grp_val(void *src) {
  int size;
...
static int set_egrp_n_grp(void *src) {
  mesh->elem_group->n_grp = *((int *)src);
  return 0;
}

static int set_egrp_n_bc(void *src) {
  mesh->elem_group->n_bc = *((int *)src);
  return 0;
}

static int set_egrp_grp_name(void *src) {
  int i;
...
static int set_egrp_grp_index(void *src) {
  int size;
...
static int set_egrp_grp_item(void *src) {
  int size;
  ...
  size = sizeof(*mesh->elem_group->grp_item) *
         mesh->elem_group->grp_index[mesh->elem_group->n_grp];
...
static int set_egrp_bc_grp_ID(void *src) {
  int size;
...
static int set_egrp_bc_grp_type(void *src) {
  int size;
...
static int set_egrp_bc_grp_index(void *src) {
  int size;
...
static int set_egrp_bc_grp_val(void *src) {
  int size;
...
static int set_sgrp_n_grp(void *src) {
  mesh->surf_group->n_grp = *((int *)src);
  return 0;
}

static int set_sgrp_n_bc(void *src) {
  mesh->surf_group->n_bc = *((int *)src);
  return 0;
}

static int set_sgrp_grp_name(void *src) {
  int i;
...
static int set_sgrp_grp_index(void *src) {
  int size;
...
static int set_sgrp_grp_item(void *src) {
  int size;
  ...
  size = sizeof(*mesh->surf_group->grp_item) * 2 *
         mesh->surf_group->grp_index[mesh->surf_group->n_grp];
...
static int set_sgrp_bc_grp_ID(void *src) {
  int size;
...
static int set_sgrp_bc_grp_type(void *src) {
  int size;
...
static int set_sgrp_bc_grp_index(void *src) {
  int size;
...
static int set_sgrp_bc_grp_val(void *src) {
  int size;
...
static int set_contact_pair_n_pair(void *src) {
  mesh->contact_pair->n_pair = *((int *)src);
  return 0;
}

static int set_contact_pair_name(void *src) {
  int i;
...
static int set_contact_pair_type(void *src) {
  int size;
...
static int set_contact_pair_slave_grp_id(void *src) {
  int size;

  if (mesh->contact_pair->n_pair <= 0) return 0;
  size =
      sizeof(*mesh->contact_pair->slave_grp_id) * (mesh->contact_pair->n_pair);
...
static int set_contact_pair_master_grp_id(void *src) {
  ...
  if (mesh->contact_pair->n_pair <= 0) return 0;
  size =
      sizeof(*mesh->contact_pair->master_grp_id) * (mesh->contact_pair->n_pair);
...
static struct func_table {
  ...
  SetFunc set_func;
    ...
    {"hecmwST_local_mesh", "when_i_was_refined_node",
     set_when_i_was_refined_node},
    {"hecmwST_local_mesh", "when_i_was_refined_elem",
     set_when_i_was_refined_elem},
...
void hecmw_dist_copy_f2c_set_if(char *struct_name, char *var_name, void *src,
  ...
  *err = 1;
  ...
  if (mesh == NULL) {
    HECMW_set_error(
        HECMW_ALL_E0102,
        "HECMW_dist_copy_f2c_set_if(): 'mesh' has not initialized yet");
    return;
  }
  if (struct_name == NULL) {
    HECMW_set_error(HECMW_ALL_E0101,
                    "HECMW_dist_copy_f2c_set_if(): 'sname' is NULL");
    return;
  }
  if (var_name == NULL) {
    HECMW_set_error(HECMW_ALL_E0101,
                    "HECMW_dist_copy_f2c_set_if(): 'vname' is NULL");
    return;
  }
  ...
  if (func == NULL) {
    HECMW_set_error(HECMW_ALL_E0102,
                    "HECMW_dist_copy_f2c_set_if(): SetFunc not found");
    return;
  }
