...
do_logging(int loglv, int msgno, int add_location, const char *fmt, va_list ap)
{
	...
	if(add_location) {
		...
		HECMW_snprintf(line, sizeof(line), "%s:%d%s", p, HECMW_ablex_get_lineno(), s);
	}
...
static void
set_err_noloc(int msgno, const char *fmt, ...)
{
	va_list ap;
...
static void
log_warn(int msgno, const char *fmt, ...)
{
	va_list ap;
...
static int
is_material_keyword(int keyword)
{
	int i;
...
static char *
get_material_string(int keyword)
{
	int i;
...
static void
set_material_zone(int flag)
{
	flag_material_zone = flag ? 1 : 0;
}


static int
add_mat_data(int keyword, struct hecmw_io_matitem *matitem)
{
	int i;
	...
	if(p) {
		...
		HECMW_free(item);
		log_warn(HECMW_IO_ABAQUS_W0095,
			"%s updated for *MATERIAL %s", get_material_string(keyword), matname);
		return 0;
	}
...
static int
read_mat_data_line_common(int nval, int nval_line, double *val, int errmsgno)
{
	int i,token;
...
static int
read_mat_data_common(int nval, int nval_line, int temp_col, struct hecmw_io_matitem **matitem, int msgno)
{
	int token;
	...
	while(1) {
		...
		if(read_mat_data_line_common(nval, nval_line, subitem->val, msgno)) goto error;
...
static int
read_param_dependencies(int *dependencies, int msgno)
{
	int token;
...
static struct etype_conv {
	...
	{ HECMW_ABLEX_E_B31,     611,  0 },
	{ HECMW_ABLEX_E_B32,     612,  0 },
	{ HECMW_ABLEX_E_C3D4,    341,  0 },
	{ HECMW_ABLEX_E_C3D6,    351,  0 },
	{ HECMW_ABLEX_E_C3D8,    361,  0 },
	{ HECMW_ABLEX_E_C3D8I,   361,  0 },
	{ HECMW_ABLEX_E_C3D10,   342,  0 },
	{ HECMW_ABLEX_E_C3D15,   352,  0 },
	{ HECMW_ABLEX_E_C3D20,   362,  0 },
	{ HECMW_ABLEX_E_CAX3,    231,  2 },
	{ HECMW_ABLEX_E_CAX4,    241,  2 },
	{ HECMW_ABLEX_E_CAX4I,   241,  2 },
	{ HECMW_ABLEX_E_CAX4R,   241, 12 },
	{ HECMW_ABLEX_E_CAX6,    232,  2 },
	{ HECMW_ABLEX_E_CAX8,    242,  2 },
	{ HECMW_ABLEX_E_CAX8R,   242, 12 },
	{ HECMW_ABLEX_E_CPE3,    231,  1 },
	{ HECMW_ABLEX_E_CPE4,    241,  1 },
	{ HECMW_ABLEX_E_CPE4I,   241,  1 },
	{ HECMW_ABLEX_E_CPE4R,   241, 11 },
	{ HECMW_ABLEX_E_CPE6,    232,  1 },
	{ HECMW_ABLEX_E_CPE8,    242,  1 },
	{ HECMW_ABLEX_E_CPE8R,   242, 11 },
	{ HECMW_ABLEX_E_CPS3,    231,  0 },
	{ HECMW_ABLEX_E_CPS4,    241,  0 },
	{ HECMW_ABLEX_E_CPS4I,   241,  0 },
	{ HECMW_ABLEX_E_CPS4R,   241, 10 },
	{ HECMW_ABLEX_E_CPS6,    232,  0 },
	{ HECMW_ABLEX_E_CPS8,    242,  0 },
	{ HECMW_ABLEX_E_CPS8R,   242, 10 },
	{ HECMW_ABLEX_E_DC1D2,   111,  0 },
	{ HECMW_ABLEX_E_DC1D3,   112,  0 },
	{ HECMW_ABLEX_E_DC2D3,   231,  0 },
	{ HECMW_ABLEX_E_DC2D4,   241,  0 },
	{ HECMW_ABLEX_E_DC2D6,   232,  0 },
	{ HECMW_ABLEX_E_DC2D8,   242,  0 },
	{ HECMW_ABLEX_E_DC3D4,   341,  0 },
	{ HECMW_ABLEX_E_DC3D6,   351,  0 },
	{ HECMW_ABLEX_E_DC3D8,   361,  0 },
	{ HECMW_ABLEX_E_DC3D10,  342,  0 },
	{ HECMW_ABLEX_E_DC3D15,  352,  0 },
	{ HECMW_ABLEX_E_DC3D20,  362,  0 },
	{ HECMW_ABLEX_E_DCAX3,   231,  2 },
	{ HECMW_ABLEX_E_DCAX4,   241,  2 },
	{ HECMW_ABLEX_E_DCAX6,   232,  0 },
	{ HECMW_ABLEX_E_DCAX8,   242,  0 },
	{ HECMW_ABLEX_E_DINTER4, 541,  0 },
	{ HECMW_ABLEX_E_DINTER8, 542,  0 },
	{ HECMW_ABLEX_E_DS4,     741,  0 },
	{ HECMW_ABLEX_E_DS8,     742,  0 },
	{ HECMW_ABLEX_E_INTER4,  541,  0 },
	{ HECMW_ABLEX_E_INTER8,  542,  0 },
	{ HECMW_ABLEX_E_S3R,     731,  0 },
	{ HECMW_ABLEX_E_S4R,     741,  0 },
	{ HECMW_ABLEX_E_S8R,     742,  0 },
	{ HECMW_ABLEX_E_T3D2,    111,  0 },
	{ HECMW_ABLEX_E_T3D3,    112,  0 },
};


static int
get_HECMW_etype(int abaqus_etype)
{
	int i;
...
static int
get_secopt_abaqus(int abaqus_etype)
{
	int i;
...
static int
get_secopt(char *elset, int msgno)
{
	int i,secopt_prev;
...
static int
read_input(int msgno_invalid_token)
{
	int token;
	char *p;
...
read_amplitude_keyword(void)
{
	...
	token = HECMW_ablex_next_token();
	if(token != ',') {
		set_err_token(token, HECMW_IO_ABAQUS_E0100, "',' required after *AMPLITUDE");
		return -1;
	}
	return 0;
}
...
static int
read_amplitude_param_name(char *name)
{
	int token;
	char *p;
	...
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E0100, "NAME must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
...
static int
read_amplitude_param_definition(int *definition)
{
	int token;

	token = HECMW_ablex_next_token();
	if(token != '=') {
		set_err_token(token, HECMW_IO_ABAQUS_E0100, "'=' required after DEFINITION");
		return -1;
	}
	token = HECMW_ablex_next_token();
...
static int
read_amplitude_param_time(int *time)
{
	int token;
...
static int
read_amplitude_param_value(int *value)
{
	int token;
...
static int
read_amplitude_data(char *name, int definition, int time, int value)
{
	int i,token;
	enum { NITEM = 4 };
	...
	while(1) {
		...
		/* add */
		if(HECMW_io_add_amp(name, definition, time, value, val, t) == NULL) return -1;
		...
		if(token == ',' && i == NITEM) {
			token = HECMW_ablex_next_token();
			if(token != HECMW_ABLEX_NL) {
				set_err_token(token, HECMW_IO_ABAQUS_E0100, "Only %d items allow per line", NITEM);
				return -1;
			}
			break;
		}
...
read_elset_param_elset(char *elset)
{
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E0500, "ELSET must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
	if(strlen(p) > HECMW_NAME_LEN) {
...
static int
read_elset_data(int *nelem, int **elem_array)
{
	int token,i,n,*elem;
	...
	while(1) {
		...
		token = HECMW_ablex_next_token();
		if(token != ',' && token != HECMW_ABLEX_NL) {
			set_err_token(token, HECMW_IO_ABAQUS_E0500, "',' or NL required after element ID");
			goto error;
		}
		if(token == HECMW_ABLEX_NL) break;
	}
...
static int
read_elset_data_generate(int *nelem, int **elem_array)
{
	...
	if(token == ',') {
		...
		token = HECMW_ablex_next_token();
		if(token != HECMW_ABLEX_NL) {
			set_err_token(token, HECMW_IO_ABAQUS_E0500, "NL required after increment");
			return -1;
		}
	} else if(token == HECMW_ABLEX_NL) {
		elem3 = 1;
	} else {
		set_err_token(token, HECMW_IO_ABAQUS_E0500, "',' or NL required after elem2");
		return -1;
	}
	...
	/* make element */
	if(elem1 > elem2) {
		set_err(HECMW_IO_ABAQUS_E0503, "Cannot generate between %d and %d with an increment of %d", elem1, elem2, elem3);
		return -1;
	}
...
static int
read_element_param_type(int *hecmw_etype, int *abaqus_etype)
{
	int token;
...
static int
read_element_param_elset(char *elset)
{
	char *p;
	int token;
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E0600, "ELSET must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
	if(strlen(p) > HECMW_NAME_LEN) {
...
static int
read_element_data(int *id, int nnode, int *node)
{
	int token,i;
	...
	*id = 0;
	...
	while(1) {
		...
		token = HECMW_ablex_next_token();
		if(token != ',' && token != HECMW_ABLEX_NL) {
			set_err_token(token, HECMW_IO_ABAQUS_E0600, "',' or NL required after connectivity");
			return -1;
		}
...
read_element(void)
{
	...
	while(state != ST_FINISHED) {
		if(state == ST_KEYWORD_LINE) {
			...
			if(HECMW_convert_connectivity(HECMW_CONNTYPE_ABAQUS, hecmw_etype, node)) return -1;
			...
			if(elem_secopt == NULL) {
				elem_secopt = (struct hecmw_map_int *) HECMW_malloc(sizeof(struct hecmw_map_int));
...
static int
read_equation_keyword(int *token)
{
	/* *EQUATION */
	*token = HECMW_ablex_next_token();
	...
	*token = HECMW_ablex_next_token();
	if(*token != ',' && *token != HECMW_ABLEX_NL) {
		set_err_token(*token, HECMW_IO_ABAQUS_E0700, "',' or NL required after *EQUATION");
		return -1;
	}
	return 0;
}
...
static int
read_equation_data_line1(int *neq)
{
	int token;
...
static int
read_equation_data_line2(int neq)
{
	...
	for(i=0; i < neq; i++) {
		...
		token = HECMW_ablex_next_token();
		if(token != ',' && token != HECMW_ABLEX_NL) {
			set_err_token(token, HECMW_IO_ABAQUS_E0700, "',' or NL required after coefficient");
			goto error;
		}
		if(token == ',' && i == NITEM-1) {
			token = HECMW_ablex_next_token();
...
read_include(void)
{
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NL) {
		set_err_token(token, HECMW_IO_ABAQUS_E0900, "NL required after INPUT value");
		return -1;
	}
...
static int
read_initial_param_type(int *type)
{
	int token;
...
read_initial_data(int type)
{
	...
	if(token == ',') {
		...
		set_err_token(token, HECMW_IO_ABAQUS_E1000, "Node ID or NGROUP name required");
		return -1;
	}
	...
	/* VAL */
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_DOUBLE && token != HECMW_ABLEX_INT && token != HECMW_ABLEX_NL) {
...
static int
read_conductivity_keyword(int *last_token)
{
	int token;
	...
	token = HECMW_ablex_next_token();
	if(token != ',' && token != HECMW_ABLEX_NL) {
		set_err_token(token, HECMW_IO_ABAQUS_E2500, "',' or NL required after *CONDUCTIVITY");
		return -1;
	}
	*last_token = token;
...
static int
read_conductivity_param_dependencies(int *dependencies)
{
...
static int
read_conductivity_param_type(int *type)
{
	int token;
	...
	switch(token) {
		...
		case HECMW_ABLEX_K_ANISOTROPIC:	break;
		default:
...
read_conductivity_data(int type, int dependencies, struct hecmw_io_matitem **matitem)
{
	...
	return read_mat_data_common(n+dependencies, 8, temp_col, matitem, HECMW_IO_ABAQUS_E2500);

}


static int
read_conductivity(void)
{
	int token,state;
...
static int
read_density_keyword(int *last_token)
{
	int token;
	...
	token = HECMW_ablex_next_token();
	if(token != ',' && token != HECMW_ABLEX_NL) {
		set_err_token(token, HECMW_IO_ABAQUS_E2200, "',' or NL required after *DENSITY");
		return -1;
	}
	*last_token = token;
...
static int
read_density_param_dependencies(int *dependencies)
{
...
static int
read_density_data(int dependencies, struct hecmw_io_matitem **matitem)
{
	return read_mat_data_common(2+dependencies, 8, 2, matitem, HECMW_IO_ABAQUS_E2200);
}
...
static int
read_elastic_keyword(int *last_token)
{
	int token;
	...
	token = HECMW_ablex_next_token();
	if(token != ',' && token != HECMW_ABLEX_NL) {
		set_err_token(token, HECMW_IO_ABAQUS_E2300, "',' or NL required after *ELASTIC");
		return -1;
	}
	*last_token = token;
...
static int
read_elastic_param_dependencies(int *dependencies)
{
...
static int
read_elastic_param_type(int *type)
{
	int token;
...
read_elastic_data(int type, int dependencies, struct hecmw_io_matitem **matitem)
{
	...
	return read_mat_data_common(n+dependencies, 8, temp_col, matitem, HECMW_IO_ABAQUS_E2300);
...
static int
read_specific_keyword(int *last_token)
{
	int token;
	...
	token = HECMW_ablex_next_token();
	if(token != ',' && token != HECMW_ABLEX_NL) {
		set_err_token(token, HECMW_IO_ABAQUS_E2400, "',' or NL required after *SPECIFIC HEAT");
		return -1;
	}
	*last_token = token;
...
static int
read_specific_param_dependencies(int *dependencies)
{
...
static int
read_specific_data(int dependencies, struct hecmw_io_matitem **matitem)
{
	return read_mat_data_common(2+dependencies, 8, 2, matitem, HECMW_IO_ABAQUS_E2400);
}


static int
read_specific_heat(void)
{
	int token,state;
	int flag_dependencies = 0;	/* flag for DEPENDENCIES */
	int dependencies = 0;
...
static int
read_material_param_name(char *name)
{
	int token;
	char *p;
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E1100, "NAME must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
	if(strlen(p) > HECMW_NAME_LEN) {
...
static int
read_nset_data(int *nnode, int **node_array)
{
	int i,n,*node,token;
	struct hecmw_io_id *head,*prev,*p,*q;
...
static int
read_nset_data_generate(int *nnode, int **node_array)
{
	...
	if(token == ',') {
		...
		token = HECMW_ablex_next_token();
		if(token != HECMW_ABLEX_NL) {
			set_err_token(token, HECMW_IO_ABAQUS_E1500, "NL required after increment");
			return -1;
		}
	} else if(token == HECMW_ABLEX_NL) {
		nod3 = 1;
	} else {
		set_err_token(token, HECMW_IO_ABAQUS_E1500, "',' or NL required after nod2");
		return -1;
	}
	HECMW_assert(token == HECMW_ABLEX_NL);
	...
	/* make node */
	if(nod1 > nod2) {
		set_err(HECMW_IO_ABAQUS_E1503, "Cannot generate between %d and %d with an increment of %d", nod1, nod2, nod3);
		return -1;
	}
	if((nod2-nod1)%nod3) {
		set_err(HECMW_IO_ABAQUS_E1503, "Cannot generate between %d and %d with an increment of %d", nod1, nod2, nod3);
...
read_node_keyword(int *token)
{
	...
	*token = HECMW_ablex_next_token();
	if(*token != HECMW_ABLEX_NL && *token != ',') {
		set_err_token(*token, HECMW_IO_ABAQUS_E1600, "',' or NL required after *NODE");
		return -1;
	}
	return 0;
}
...
static int
read_node_param_system(int *system)
{
	int token;
...
read_node_param_nset(char *nset)
{
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E1600, "NSET must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
	if(strlen(p) > HECMW_NAME_LEN) {
...
static int
read_node_data(int *id, double *x, double *y, double *z)
{
	int token;
...
static int
read_node_data_system(int system, double *x, double *y, double *z)
{
...
read_shellsect_keyword(void)
{
	...
	token = HECMW_ablex_next_token();
	if(token != ',') {
		set_err_token(token, HECMW_IO_ABAQUS_E1700, "',' required after *SHELL SECTION");
		return -1;
	}
	return 0;
}
...
static int
read_shellsect_param_elset(char *elset)
{
	int token;
	char *p;
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E1700, "ELSET must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
	if(strlen(p) > HECMW_NAME_LEN) {
...
static int
read_shellsect_param_material(char *material)
{
	int token;
	char *p;
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E1700, "MATERIAL must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
	if(strlen(p) > HECMW_NAME_LEN) {
...
static int
read_shellsect_data(double *thickness, int *integpoints)
{
	int token;
	...
	*integpoints = 0;
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NL) {
		set_err_token(token, HECMW_IO_ABAQUS_E1700, "NL required after INTEGPOINTS");
		return -1;
	}
...
static int
read_solidsect_param_elset(char *elset)
{
	int token;
	char *p;
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E2100, "ELSET must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
	if(strlen(p) > HECMW_NAME_LEN) {
...
static int
read_solidsect_param_material(char *material)
{
	int token;
	char *p;
	...
	token = HECMW_ablex_next_token();
	if(token != HECMW_ABLEX_NAME) {
		set_err_token(token, HECMW_IO_ABAQUS_E2100, "MATERIAL must begin with a letter");
		return -1;
	}
	p = HECMW_ablex_get_text();
	if(strlen(p) > HECMW_NAME_LEN) {
...
read_boundary_data(int *nnode, int **node_array)
{
	...
	while(1) {
		...
		if(token != HECMW_ABLEX_INT && token != HECMW_ABLEX_DOUBLE && token != ',') {
			set_err_token(token, HECMW_IO_ABAQUS_E1500, "Error input");
			goto error;
		}
...
int
HECMW_read_abaqus_mesh(const char *filename)
{
	FILE *fp;
	...
	if(filename == NULL) {
		set_err_noloc(HECMW_IO_E0001, "Not specified filename for ABAQUS mesh input routine");
		return -1;
	}
	...
	if((fp = fopen(filename, "r")) == NULL) {
		set_err_noloc(HECMW_IO_ABAQUS_E0001, "File: %s, %s", filename, strerror(errno));
		return -1;
	}
	...
	if(fclose(fp)) {
		set_err_noloc(HECMW_IO_ABAQUS_E0002, "File: %s, %s", filename, strerror(errno));
		return -1;
	}
...
HECMW_get_abaqus_mesh(const char *filename)
{
