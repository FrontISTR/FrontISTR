...
int HECMW_read_geofem_mesh(const char *filename) {
  ...
  if (filename == NULL) {
    HECMW_set_error(HECMW_IO_E0001,
                    "Not specified filename for GeoFEM mesh input routine");
    return -1;
  }
