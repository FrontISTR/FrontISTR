...
!        Category : Utility for performance tuning                     !
!                                                                      !
!            Written by KITAYAMA Takeshi (JFETEC)                      !
!                                                                      !
...
! default block reordering parameter
        ...
        if (present(block_inout_ratio)) then
          if (block_inout_ratio .le. 0.001) then
            ratio = 0.001
          else if (block_inout_ratio .ge. 0.999) then
            ratio = 0.999
          else
