...
struct hecmw_msgent hecmw_msg_table[] = {
	...
	{HECMW_IO_INP_E0001,"HECMW-IO-INP-E0001","Failed to open INP mesh file"},
	{HECMW_IO_INP_E0002,"HECMW-IO-INP-E0002","Failed to close INP mesh file"},
	{HECMW_IO_INP_E0003,"HECMW-IO-INP-E0003","Unexpected EOF found"},
	{HECMW_IO_INP_E0096,"HECMW-IO-INP-E0096","This keyword must be appeared after *MATERIAL"},
	{HECMW_IO_INP_E0098,"HECMW-IO-INP-E0098","Invalid token found while reading keyword"},
	{HECMW_IO_INP_E0100,"HECMW-IO-INP-E0100","*AMPLITUDE: Invalid token"},
	{HECMW_IO_INP_E0101,"HECMW-IO-INP-E0101","*AMPLITUDE: Missing NAME"},
	{HECMW_IO_INP_E0200,"HECMW-IO-INP-E0200","*CONNECTIVITY: Invalid token"},
	{HECMW_IO_INP_E0300,"HECMW-IO-INP-E0300","*ECOPY: Invalid token"},
	{HECMW_IO_INP_E0400,"HECMW-IO-INP-E0400","*EGEN: Invalid token"},
	{HECMW_IO_INP_E0500,"HECMW-IO-INP-E0500","*ELSET: Invalid token"},
	{HECMW_IO_INP_E0501,"HECMW-IO-INP-E0501","*ELSET: Missing EGRP"},
	{HECMW_IO_INP_E0502,"HECMW-IO-INP-E0502","*ELSET: elem1,elem2 and increment must be positive integer"},
	{HECMW_IO_INP_E0503,"HECMW-IO-INP-E0503","*ELSET: Cannot generate element ID"},
	{HECMW_IO_INP_E0600,"HECMW-IO-INP-E0600","*ELEMENT: Invalid token"},
	{HECMW_IO_INP_E0601,"HECMW-IO-INP-E0601","*ELEMENT: Unsuppotred element type"},
	{HECMW_IO_INP_E0603,"HECMW-IO-INP-E0603","*ELEMENT: Element ID must be posivive integer"},
	{HECMW_IO_INP_E0604,"HECMW-IO-INP-E0604","*ELEMENT: Connectivity must be posivive integer"},
	{HECMW_IO_INP_E0605,"HECMW-IO-INP-E0605","*ELEMENT: Existent node required for connectivity"},
	{HECMW_IO_INP_E0606,"HECMW-IO-INP-E0606","*ELEMENT: Missing TYPE"},
	{HECMW_IO_INP_E0700,"HECMW-IO-INP-E0700","*EQUATION: Invalid token"},
	{HECMW_IO_INP_E0701,"HECMW-IO-INP-E0701","*EQUATION: NEQ must be greater than 1"},
	{HECMW_IO_INP_E0702,"HECMW-IO-INP-E0702","*EQUATION: Node must be defined by same type(Node ID or NGRP)"},
	{HECMW_IO_INP_E0703,"HECMW-IO-INP-E0703","*EQUATION: DOF must be between 1 and 6"},
	{HECMW_IO_INP_E0800,"HECMW-IO-INP-E0800","*HEADING: Invalid token"},
	{HECMW_IO_INP_E0900,"HECMW-IO-INP-E0900","*INCLUDE: Invalid token"},
	{HECMW_IO_INP_E0901,"HECMW-IO-INP-E0901","*INCLUDE: Missing INPUT"},
	{HECMW_IO_INP_E1000,"HECMW-IO-INP-E1000","*INITIAL CONDITION: Invalid token"},
	{HECMW_IO_INP_E1001,"HECMW-IO-INP-E1001","*INITIAL CONDITION: Missing TYPE"},
	{HECMW_IO_INP_E1002,"HECMW-IO-INP-E1002","*INITIAL CONDITION: Node ID must be posivive integer"},
	{HECMW_IO_INP_E1100,"HECMW-IO-INP-E1100","*MATERIAL: Invalid token"},
	{HECMW_IO_INP_E1101,"HECMW-IO-INP-E1101","*MATERIAL: Missing NAME"},
	{HECMW_IO_INP_E1102,"HECMW-IO-INP-E1102","*MATERIAL: Duplicated material name"},
	{HECMW_IO_INP_E1103,"HECMW-IO-INP-E1103","*MATERIAL: ITEM must be positive integer"},
	{HECMW_IO_INP_E1104,"HECMW-IO-INP-E1104","*MATERIAL: *ITEM value must be positive integer"},
	{HECMW_IO_INP_E1105,"HECMW-IO-INP-E1105","*MATERIAL: *ITEM value must be 1 to SUBITEM"},
	{HECMW_IO_INP_E1106,"HECMW-IO-INP-E1106","*MATERIAL: SUBITEM value must be positive integer"},
	{HECMW_IO_INP_E1107,"HECMW-IO-INP-E1107","*MATERIAL: Temperature must be greater than previous one"},
	{HECMW_IO_INP_E1200,"HECMW-IO-INP-E1200","*NCOPY: Invalid token"},
	{HECMW_IO_INP_E1300,"HECMW-IO-INP-E1300","*NFILL: Invalid token"},
	{HECMW_IO_INP_E1400,"HECMW-IO-INP-E1400","*NGEN: Invalid token"},
	{HECMW_IO_INP_E1500,"HECMW-IO-INP-E1500","*NSET: Invalid token"},
	{HECMW_IO_INP_E1501,"HECMW-IO-INP-E1501","*NSET: Missing NGRP"},
	{HECMW_IO_INP_E1502,"HECMW-IO-INP-E1502","*NSET: nod1,nod2 and increment must be positive integer"},
	{HECMW_IO_INP_E1503,"HECMW-IO-INP-E1503","*NSET: Cannot generate node ID"},
	{HECMW_IO_INP_E1600,"HECMW-IO-INP-E1600","*NODE: Invalid token"},
	{HECMW_IO_INP_E1601,"HECMW-IO-INP-E1601","*NODE: Node ID must be positive integer"},
	{HECMW_IO_INP_E1700,"HECMW-IO-INP-E1700","*SHELL SECTION: Invalid token"},
	{HECMW_IO_INP_E1701,"HECMW-IO-INP-E1701","*SHELL SECTION: Missing TYPE"},
	{HECMW_IO_INP_E1702,"HECMW-IO-INP-E1702","*SHELL SECTION: Missing ELSET"},
	{HECMW_IO_INP_E1703,"HECMW-IO-INP-E1703","*SHELL SECTION: MATERIAL and COMPOSITE are mutually exclusive"},
	{HECMW_IO_INP_E1704,"HECMW-IO-INP-E1704","*SHELL SECTION: COMPOSITE value must be positive integer"},
	{HECMW_IO_INP_E1705,"HECMW-IO-INP-E1705","*SHELL SECTION: THICKNESS must be greater than 0.0"},
	{HECMW_IO_INP_E1706,"HECMW-IO-INP-E1706","*SHELL SECTION: INTEGPOINTS must be positive integer"},
	{HECMW_IO_INP_E1707,"HECMW-IO-INP-E1707","*SHELL SECTION: Missing MATERIAL or COMPOSITE"},
	{HECMW_IO_INP_E1800,"HECMW-IO-INP-E1800","*SGROUP: Invalid token"},
	{HECMW_IO_INP_E1801,"HECMW-IO-INP-E1801","*SGROUP: Missing SGRP"},
	{HECMW_IO_INP_E1900,"HECMW-IO-INP-E1900","*SYSTEM: Invalid token"},
	{HECMW_IO_INP_E2000,"HECMW-IO-INP-E2000","*ZERO: Invalid token"},
	{HECMW_IO_INP_E2100,"HECMW-IO-INP-E2100","*SOLID SECTION: Invalid token"},
	{HECMW_IO_INP_E2101,"HECMW-IO-INP-E2101","*SOLID SECTION: Missing TYPE"},
	{HECMW_IO_INP_E2102,"HECMW-IO-INP-E2102","*SOLID SECTION: Missing ELSET"},
	{HECMW_IO_INP_E2103,"HECMW-IO-INP-E2103","*SOLID SECTION: MATERIAL and COMPOSITE are mutually exclusive"},
	{HECMW_IO_INP_E2104,"HECMW-IO-INP-E2104","*SOLID SECTION: COMPOSITE value must be positive integer"},
	{HECMW_IO_INP_E2105,"HECMW-IO-INP-E2105","*SOLID SECTION: THICKNESS must be greater than 0.0"},
	{HECMW_IO_INP_E2106,"HECMW-IO-INP-E2106","*SOLID SECTION: INTEGPOINTS must be positive integer"},
	{HECMW_IO_INP_E2107,"HECMW-IO-INP-E2107","*SOLID SECTION: Only one secopt can be allowed in element group"},
	{HECMW_IO_INP_E2108,"HECMW-IO-INP-E2108","*SOLID SECTION: Missing MATERIAL or COMPOSITE"},
	{HECMW_IO_INP_E2200,"HECMW-IO-INP-E2200","*DENSITY: Invalid token"},
	{HECMW_IO_INP_E2300,"HECMW-IO-INP-E2300","*ELASTIC: Invalid token"},
	{HECMW_IO_INP_E2400,"HECMW-IO-INP-E2400","*SPECIFIC HEAT: Invalid token"},
	{HECMW_IO_INP_E2500,"HECMW-IO-INP-E2500","*CONDUCTIVITY: Invalid token"},
	{HECMW_IO_INP_W0095,"HECMW-IO-INP-W0095","Redefined material information, updated"},
	{HECMW_IO_INP_W0097,"HECMW-IO-INP-W0097","Unsupported keyword found"},
	{HECMW_IO_INP_W0099,"HECMW-IO-INP-W0099","Skipped unsupported keyword"},
