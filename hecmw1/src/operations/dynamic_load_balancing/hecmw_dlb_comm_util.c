...
int stack_whole_send_recv(int pesize, int *stack_export, int *stack_import,
  ...
  /*
    ...
    if (nflag == 0) {
      sta1 = (HECMW_Status *)calloc(HECMW_STATUS_SIZE*(pesize-1),
    sizeof(HECMW_Status));
      if (sta1 == NULL)
                  HECMW_vis_memory_exit("HECMW_STATUS: stat1");
      sta2 = (HECMW_Status *)calloc(HECMW_STATUS_SIZE*(pesize-1),
    sizeof(HECMW_Status));
      if (sta2 == NULL)
...
int double_part_send_recv(int n, int neibpetot, int *neibpe, int *stack_import,
  ...
  if ((ws == NULL) || (wr == NULL)) HECMW_vis_memory_exit("send_recv: ws, wr");
  if (nflag == 0) {
    sta1 = (HECMW_Status *)calloc(HECMW_STATUS_SIZE * neibpetot,
                                  sizeof(HECMW_Status));
    if (sta1 == NULL) HECMW_vis_memory_exit("send_recv: sta1");
    sta2 = (HECMW_Status *)calloc(HECMW_STATUS_SIZE * neibpetot,
                                  sizeof(HECMW_Status));
...
void int_whole_send_recv(int n1, int n2, int pesize, int *stack_import,
  ...
  */
  ...
  if (nflag == 0) {
    /*    sta1 = (HECMW_Status *)calloc(HECMW_STATUS_SIZE,
       sizeof(HECMW_Status));
        if (sta1 == NULL) {
        ...
        if (sta2 == NULL) {
          ...
          exit(1);
            ...
            */
    if ((req1 = (HECMW_Request *)calloc(pesize, sizeof(HECMW_Request))) == NULL)
      HECMW_vis_memory_exit("send_recv: req1");
    if ((req2 = (HECMW_Request *)calloc(pesize, sizeof(HECMW_Request))) == NULL)
      HECMW_vis_memory_exit("send_recv: req2");
    nflag = 1;
  }
  /* SEND */
...
void int2_whole_send_recv(int n1, int n2, int pesize, int *stack_import,
  ...
  if (nflag == 0) {
    sta1 = (HECMW_Status *)calloc(HECMW_STATUS_SIZE * pesize,
                                  sizeof(HECMW_Status));
    if (sta1 == NULL) HECMW_vis_memory_exit("send_recv: sta1");
    sta2 = (HECMW_Status *)calloc(HECMW_STATUS_SIZE * pesize,
                                  sizeof(HECMW_Status));
