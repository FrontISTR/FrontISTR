...
!C***
!C*** module hecmw_solver_SAI_GMRES_nn
!C***
!
      module hecmw_solver_SAI_GMRES_nn
      contains
!C
!C*** hecmw_solve_SAI_GMRES_nn
!C
      subroutine hecmw_solve_SAI_GMRES_nn                               &
...
!C
     ...
     &                                     + AMATsai(kSB+8)*X3
      ...
      end subroutine  hecmw_solve_SAI_GMRES_nn
      end module     hecmw_solver_SAI_GMRES_nn
