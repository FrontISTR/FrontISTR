...
!C***
!C*** module hecmw_solver_SAI_GPBiCG_nn
!C***
!
      module hecmw_solver_SAI_GPBiCG_nn
      contains
!C
!C*** hecmw_solve_GPBiCG_nn
!C
      subroutine hecmw_solve_SAI_GPBiCG_nn                              &
...
!C===
      indexB= R
      call hecmw_solve_SAI_init_resid_nn (indexB)
...
!C===
      ...
      indexA= WK
      indexB= R
      call hecmw_solve_SAI_precond_nn (indexA, indexB)
!C===
...
!C-- calc. {p_tld}= A{p}
      ...
      indexA= P
      indexB= PT
      call hecmw_solve_SAI_matvec_nn  (indexA, indexB)
...
!C
!C***
!C*** hecmw_solve_SAI_init_resid_nn
!C***
!C

      subroutine hecmw_solve_SAI_init_resid_nn (indexB)
      implicit REAL*8 (A-H,O-Z)
     ...
     &     STACK_EXPORT, NOD_EXPORT, WS, WR, X , SOLVER_COMM,my_rank)
      ...
      end subroutine hecmw_solve_SAI_init_resid_nn

!C
!C***
!C*** hecmw_solve_SAI_matvec_nn
!C***
!C
      subroutine hecmw_solve_SAI_matvec_nn (indexA, indexB)
      implicit REAL*8 (A-H,O-Z)
     ...
     &     SOLVER_COMM,my_rank)
      ...
      end subroutine hecmw_solve_SAI_matvec_nn

!C
!C***
!C*** hecmw_solve_SAI_precond_nn
!C***
!C
      subroutine hecmw_solve_SAI_precond_nn (indexA, indexB)
      implicit REAL*8 (A-H,O-Z)
      integer(kind=kint) :: indexA,indexB
     ...
     &                                     + AMATsai(kSB+8)*X3
      ...
      end subroutine hecmw_solve_SAI_precond_nn

      end subroutine  hecmw_solve_SAI_GPBiCG_nn
      end module     hecmw_solver_SAI_GPBiCG_nn
