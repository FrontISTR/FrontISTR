...
!C
!C***
!C*** module hecmw_solver_BiCGSTAB_nn
!C***
!C
      module hecmw_solver_BiCGSTAB_nn
      contains
!C
!C*** BiCGSTAB_3
!C
      subroutine hecmw_solve_BiCGSTAB_nn( hecMESH,  hecMAT, ITER, RESID, ERROR, &
     &                                    Tset, Tsol, Tcomm )
...
!C +--------------------+
!C===
      call hecmw_precond_nn_apply(hecMESH, hecMAT, WW(:, P), WW(:, PT), WW(:, WK), Tcomm)
...
!C +-------------------------+
!C===
      call hecmw_matvec_nn(hecMESH, hecMAT, WW(:,PT), WW(:,V), Tcomm)
...
!C +--------------------+
!C===
      call hecmw_precond_nn_apply(hecMESH, hecMAT, WW(:, S), WW(:, ST), WW(:, WK), Tcomm)
...
!C +-------------------------+
!C===
      call hecmw_matvec_nn(hecMESH, hecMAT, WW(:,ST), WW(:,T), Tcomm)
...
!C
      ...
      end subroutine hecmw_solve_BiCGSTAB_nn
      end module     hecmw_solver_BiCGSTAB_nn
