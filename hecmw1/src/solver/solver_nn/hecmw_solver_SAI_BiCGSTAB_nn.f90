...
!C
!C***
!C*** module hecmw_solver_SAI_BiCGSTAB_nn
!C***
!C
      module hecmw_solver_SAI_BiCGSTAB_nn
      contains
!C
!C*** hecmw_solve_SAI_BiCGSTAB_nn
!C
      subroutine hecmw_solve_SAI_BiCGSTAB_nn                            &
...
!C-- INTERFACE data EXCHANGE
     ...
     &     STACK_EXPORT, NOD_EXPORT, WS, WR, X , SOLVER_COMM, my_rank)
      ...
      end subroutine hecmw_solve_SAI_BiCGSTAB_nn
      end module     hecmw_solver_SAI_BiCGSTAB_nn
