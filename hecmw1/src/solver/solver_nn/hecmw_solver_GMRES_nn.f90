...
!C***
!C*** module hecmw_solver_GMRES_nn
!C***
!
      module hecmw_solver_GMRES_nn

      public :: hecmw_solve_GMRES_nn

      contains
!C
!C*** hecmw_solve_GMRES_nn
!C
      subroutine hecmw_solve_GMRES_nn( hecMESH,  hecMAT, ITER, RESID, ERROR, &
     &                                    Tset, Tsol, Tcomm )
      use hecmw_util
...
!C +-------------------+
!C===
      call hecmw_precond_nn_apply(hecMESH, hecMAT, WW(:,V+I-1), WW(:,ZQ), WW(:,ZP), Tcomm)

      call hecmw_matvec_nn(hecMESH, hecMAT, WW(:,ZQ), WW(:,W), Tcomm)
!C===
...
!C-- {x}= {x} + {y}{V}
         ...
         call hecmw_precond_nn_apply(hecMESH, hecMAT, WW(:,AV), WW(:,ZQ), WW(:,ZP), Tcomm)
...
!C-- INTERFACE data EXCHANGE
      ...
      end subroutine  hecmw_solve_GMRES_nn

      end module     hecmw_solver_GMRES_nn
