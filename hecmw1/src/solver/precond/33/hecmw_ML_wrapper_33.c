...
extern void hecmw_ml_getrow_33_(int *id, int *n_requested_rows, int *requested_rows, int *allocated_space, int *cols, double *values, int *row_lengths, int *ierr);
extern void hecmw_ml_matvec_33_(int *id, int *in_length, double *p, int *out_length, double *ap, int *ierr);
extern void hecmw_ml_comm_33_(int *id, double *x, int *ierr);
extern void hecmw_ml_get_nlocal_33_(int *id, int *nlocal, int *nlocal_allcolumns, int *ierr);
extern void hecmw_ml_get_coord_33_(int *id, double x[], double y[], double z[], int *ierr);

static int hecmw_ML_getrow_33(
	ML_Operator *mat_in,
	...
	int row_lengths[])
{
	...
	hecmw_ml_getrow_33_(id, &N_requested_rows, requested_rows,
			 &allocated_space, cols, values, row_lengths, &ierr);
	return ierr;
}

static int hecmw_ML_matvec_33(
	ML_Operator *mat_in,
	int in_length,
	double p[],
	int out_length,
...
void hecmw_ML_wrapper_setup_33(int *id, int *sym, int *ierr)
{
	...
	ML_Set_Amatrix_Getrow(ml_object, 0,
			      hecmw_ML_getrow_33, hecmw_ML_comm_33,
			      nlocal_allcolumns);
	...
	/* 				    ML_BOTH, 1, 1.0, Ndof); */
	{
		...
		for (level = 0; level < coarsest_level; level++) {
			ML_Gen_Smoother_Cheby(ml_object, level,
					      ML_BOTH, 20.0, 2);
		}
...
void hecmw_ml_wrapper_setup_33_(int *id, int *sym, int *ierr) { hecmw_ML_wrapper_setup_33(id, sym, ierr); }
void hecmw_ml_wrapper_setup_33__(int *id, int *sym, int *ierr) { hecmw_ML_wrapper_setup_33(id, sym, ierr); }
void HECMW_ML_WRAPPER_SETUP_33(int *id, int *sym, int *ierr) { hecmw_ML_wrapper_setup_33(id, sym, ierr); }

void hecmw_ml_wrapper_apply_33_(int *id, double rhs[], int *ierr) { hecmw_ML_wrapper_apply_33(id, rhs, ierr); }
void hecmw_ml_wrapper_apply_33__(int *id, double rhs[], int *ierr) { hecmw_ML_wrapper_apply_33(id, rhs, ierr); }
void HECMW_ML_WRAPPER_APPLY_33(int *id, double rhs[], int *ierr) { hecmw_ML_wrapper_apply_33(id, rhs, ierr); }

void hecmw_ml_wrapper_clear_33_(int *id, int *ierr) { hecmw_ML_wrapper_clear_33(id, ierr); }
void hecmw_ml_wrapper_clear_33__(int *id, int *ierr) { hecmw_ML_wrapper_clear_33(id, ierr); }
void HECMW_ML_WRAPPER_CLEAR_33(int *id, int *ierr) { hecmw_ML_wrapper_clear_33(id, ierr); }
