...
module hecmw_solve_SAI_make_nn
contains
!C
!C*** hecmw_solve_SAImake_nn
!C
!C    construct sparse approximate inverse (SAI) preconditioner
!C    using LAPACK
!C

      subroutine hecmw_solve_SAImake_nn                                 &
...
!C===
      ...
      end subroutine hecmw_solve_SAImake_nn
end module hecmw_solve_SAI_make_nn
