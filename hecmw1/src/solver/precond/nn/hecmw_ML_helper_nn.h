...
extern void hecmw_ml_smoother_setup_nn_(int *id, int *ierr);
extern void hecmw_ml_smoother_apply_nn_(int *id, int *x_length, double x[],
                                        int *rhs_length, double rhs[], int *ierr);
extern void hecmw_ml_smoother_clear_nn_(int *id, int *ierr);
...
extern int hecmw_ML_smoother_apply_nn(ML_Smoother *data, int x_length, double x[],
