...
extern void hecmw_ml_getrow_(int *id, int *n_requested_rows, int *requested_rows, int *allocated_space, int *cols, double *values, int *row_lengths, int *ierr);
extern void hecmw_ml_matvec_(int *id, int *in_length, double *p, int *out_length, double *ap, int *ierr);
	...
	int row_lengths[])
{
	...
	hecmw_ml_getrow_(id, &N_requested_rows, requested_rows,
			 &allocated_space, cols, values, row_lengths, &ierr);
	return ierr;
}

static int hecmw_ML_matvec(
	ML_Operator *mat_in,
	int in_length,
	double p[],
	int out_length,
...
void hecmw_ml_wrapper_setup_(int *id, int *sym, int *ndof, int *ierr) { hecmw_ML_wrapper_setup(id, sym, ndof, ierr); }
void hecmw_ml_wrapper_setup__(int *id, int *sym, int *ndof, int *ierr) { hecmw_ML_wrapper_setup(id, sym, ndof, ierr); }
void HECMW_ML_WRAPPER_SETUP(int *id, int *sym, int *ndof, int *ierr) { hecmw_ML_wrapper_setup(id, sym, ndof, ierr); }
...
void HECMW_ML_WRAPPER_APPLY(int *id, double rhs[], int *ierr) { hecmw_ML_wrapper_apply(id, rhs, ierr); }

void hecmw_ml_wrapper_clear_(int *id, int *ierr) { hecmw_ML_wrapper_clear(id, ierr); }
void hecmw_ml_wrapper_clear__(int *id, int *ierr) { hecmw_ML_wrapper_clear(id, ierr); }
void HECMW_ML_WRAPPER_CLEAR(int *id, int *ierr) { hecmw_ML_wrapper_clear(id, ierr); }
