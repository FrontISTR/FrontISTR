...
module hecmw_precond_SAINV_33
  ...
  public:: hecmw_precond_SAINV_33_setup
  public:: hecmw_precond_SAINV_33_apply
  public:: hecmw_precond_SAINV_33_clear
...
contains
  ...
  !C***
  subroutine hecmw_precond_SAINV_33_setup(hecMAT)
    implicit none
  ...
  end subroutine hecmw_precond_SAINV_33_setup
  ...
  subroutine hecmw_precond_SAINV_33_apply(R, ZP)
    implicit none
  ...
  !C*** FORM_ILU1_33
  !C*** form ILU(1) matrix
  subroutine FORM_ILU1_SAINV_33(hecMAT)
    implicit none
    type(hecmwST_matrix) :: hecMAT
    ...
    do i= 1, hecMAT%NP
      ...
      do k= 1, icouL3
        IW2(k)= k
      enddo
      call SAINV_SORT_33 (IW1, IW2, icouL3, hecMAT%NP)
      ...
      do k= 1, icouU3
        IW2(k)= k
      enddo
      call SAINV_SORT_33 (IW1, IW2, icouU3, hecMAT%NP)
  ...
  subroutine hecmw_precond_SAINV_33_clear()
    implicit none
  ...
  end subroutine hecmw_precond_SAINV_33_clear
