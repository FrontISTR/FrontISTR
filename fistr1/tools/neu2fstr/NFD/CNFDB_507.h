...
class CNFDB_507 : public CNFDataBlock {
 ...
 protected:
  void read_structural_load(class CNFData* nfd,
                            std::vector<cstructural_load_rec>& list);
  void read_geometric_load(class CNFData* nfd,
                           std::vector<cgeometric_load_rec>& list);
  void read_temp_load(class CNFData* nfd, std::vector<ctemp_load_rec>& list);
  void write_structural_load(class CNFData* nfd, FILE* fp,
                             std::vector<cstructural_load_rec>& list);
  void write_geometric_load(class CNFData* nfd, FILE* fp,
                            std::vector<cgeometric_load_rec>& list);
  void write_temp_load(class CNFData* nfd, FILE* fp,
