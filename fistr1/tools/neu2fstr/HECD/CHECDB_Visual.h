...
class CVis_ViewParams {
 ...
 public:
  ...
  static void WriteVisParam(class CHECData* hecd, const char* name,
                            const char* fmt, ...);
  static void WriteVisPArry(class CHECData* hecd, const char* name, char type,
                            int n, void* p);  // for array
  ...
  static int ReadVisValue(
      char* s, int n, char* value);  // n:sizeof(value), return:strlen(value)
  template <class T>
