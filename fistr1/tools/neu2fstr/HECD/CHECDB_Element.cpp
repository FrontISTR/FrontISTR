...
int *Connectivity(int type, int face_id, int &n) {
  ...
  static int tc342[][20] = {{1, 4, 2, 9, 3, 8},
                            {0, 7, 3, 9, 2, 5},
                            {0, 6, 1, 8, 3, 7},
                            {0, 5, 2, 4, 1, 6}};
  static int tn342[]     = {6, 6, 6, 6, 0};
  static int tc351[][20] = {
      {1, 2, 5, 4}, {2, 0, 3, 5}, {0, 1, 4, 3}, {2, 1, 0}, {3, 4, 5}};
  static int tn351[]     = {4, 4, 4, 3, 3, 0};
  static int tc352[][20] = {{1, 6, 2, 14, 5, 9, 4, 13},
                            {2, 7, 0, 12, 3, 10, 5, 14},
                            {0, 8, 1, 13, 4, 11, 3, 12},
                            {2, 6, 1, 8, 0, 7},
                            {3, 11, 4, 9, 5, 10}};
  static int tn352[]     = {8, 8, 8, 6, 6, 0};
  static int tc361[][20] = {{3, 0, 4, 7}, {1, 2, 6, 5}, {0, 1, 5, 4},
                            {2, 3, 7, 6}, {3, 2, 1, 0}, {4, 5, 6, 7}};
  ...
  static int tc542[][20] = {{3, 10, 2, 9, 1, 8, 0, 11},
                            {4, 12, 5, 13, 6, 14, 7, 15}};
...
bool CHECDB_Element::CheckType(int type) {
  const int type_list[] = {111, 112, 231, 232, 241, 242, 351, 352, 361,
                           362, 541, 542, 611, 612, 731, 732, 741, 742};
...
CHECDB_Element::~CHECDB_Element() { Clear(); }

void CHECDB_Element::Clear() { ElemList.clear(); }
