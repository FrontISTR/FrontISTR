...
contains
  ...
  logical function fstr_is_contact_conv(ctAlgo,infoCTChange,hecMESH)
    ...
    if( sum(infoCTChange%n_statechange) + infoCTChange%contact2neighbor + infoCTChange%contact2beyond + &
        infoCTChange%free2contact_new + infoCTChange%contact2diffLpos == 0 ) &
