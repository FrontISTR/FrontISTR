    ...
    do ig0= 1, fstrSOLID%BOUNDARY_ngrp_tot
      ...
      do ik= iS0, iE0
        ...
        do idof=idof1,idof2
          ...
          !count insert force as reaction force
          if( associated(fstrSOLID%INSERT_NFORCE) ) fstrSOLID%REACTION(ndof*(in-1)+idof) = &
                &  fstrSOLID%QFORCE(ndof*(in-1)+idof) - fstrSOLID%INSERT_NFORCE(ndof*(in-1)+idof)
        enddo
      enddo
    enddo
