...
!C***
!C
      subroutine heat_GET_CONDUCTIVITY ( Tpoi,imat,COND,ntab,temp &
     &                                                 ,funcA,funcB )
...
!C*--------------------------------------------------------------------*
      SUBROUTINE heat_THERMAL_231 (NN,XX,YY,ZZ,TT,IMAT,THICK,SS &
     &                                          ,ntab,temp,funcA,funcB)
!C*--------------------------------------------------------------------*
!C*
...
!C*--------------------------------------------------------------------*
      SUBROUTINE heat_THERMAL_241 (NN,XX,YY,ZZ,TT,IMAT,THICK,SS &
     &                                          ,ntab,temp,funcA,funcB)
!C*--------------------------------------------------------------------*
!C*
...
!*---------------------------------------------------------------------*
      SUBROUTINE heat_THERMAL_341 (NN,XX,YY,ZZ,TT,IMAT,SS &
     &                                          ,ntab,temp,funcA,funcB)
!*---------------------------------------------------------------------*
!*
...
!*---------------------------------------------------------------------*
      SUBROUTINE heat_THERMAL_351 (NN,XX,YY,ZZ,TT,IMAT,SS &
     &                                        ,ntab,temp,funcA,funcB)
!*---------------------------------------------------------------------*
!*
