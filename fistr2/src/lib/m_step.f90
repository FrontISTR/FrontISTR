...
module m_step
   ...
   type step_info
      ...
      integer :: max_incr                       !< max number of iteration
   ...
   contains
     ...
     logical function isBoundaryActive( bnd, stepinfo )
        ...
        if( any( stepinfo%Boundary== bnd ) ) then
     ...
     logical function isContactActive( bnd, stepinfo )
        ...
        if( any( stepinfo%Contact== bnd ) ) then
